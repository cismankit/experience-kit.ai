    ...
    >
      <div className={cn("h-full rounded-[15px] bg-white", roomy ? "p-6 sm:p-8" : "p-5 sm:p-6")}>
        ...
        >
          ...
          <div className="rounded-lg border border-slate-100 bg-stone-50/80 px-3 py-2">
            <dt className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">Daily missions</dt>
        ...
        <div className="mt-4 rounded-xl border border-amber-100 bg-amber-50/50 px-3 py-3">
          <p className="text-[10px] font-semibold uppercase tracking-wider text-amber-900">Learner builds</p>
        ...
        <div className="mt-4 rounded-lg border border-slate-100 bg-slate-50/90 px-3 py-2">
          <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">Final artifact</p>
        ...
        >
          ...
          <Button variant="outline" size="md" href={`/kits#${kit.id}`} className="w-full bg-white sm:w-auto">
